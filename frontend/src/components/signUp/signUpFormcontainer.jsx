...
function SignUpFormcontainer() {
  ...
  return (
    <div className="d-flex flex-column mt-3">
      <div className="ms-4">
        <svg xmlns="http://www.w3.org/2000/svg" width="175.465" height="60.374" viewBox="0 0 401.465 60.374">
          <g id="surface1" transform="translate(44.672 -174.574)">
            ...
            <path id="square" d="M12.469,95.949h40v32h-40Zm0,0" transform="translate(-48.57 106.999)" fill="#263238"/>
            <path id="triangle" d="M12.469,63.262l28.57-40,28.57,40Zm0,0" transform="translate(-57.141 151.312)" fill="#ffb300"/>
            ...
            <rect id="Rectangle_2" data-name="Rectangle 2" width="25" height="6" rx="3" transform="translate(171.967 203.948)" fill="#37474f"/>
          </g>
        </svg>
      </div>
      <span className="divider"/>
      <h4 className="text-center font-weight-bold mt-3">Regístrate, y encuentra el tutor perfecto</h4>
      <SignUpForm />
      <span className="divider" />
